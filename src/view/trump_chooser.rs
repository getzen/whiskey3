...
impl TrumpChooser {
    pub async fn new(position: Vec2, sender: Sender<PlayerAction>) -> Self {
        ...
        let mut club_button = ButtonShaded::new(vec2(-90.0, 0.), tex, tex_mult);
        ...
        let mut diamond_button = ButtonShaded::new(vec2(-30.0, 0.), tex, tex_mult);
        ...
        let mut heart_button = ButtonShaded::new(vec2(30.0, 0.), tex, tex_mult);
        ...
        let mut spade_button = ButtonShaded::new(vec2(90.0, 0.), tex, tex_mult);
